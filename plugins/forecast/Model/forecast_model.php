...
class Forecast_Model extends Model {
	...
	public function sendMail() {
		...
		$mail->Username = 'ghostlikitchen@gmail.com';

		//Password to use for SMTP authentication
		$mail->Password = 'Mothugs123!';

		//Set who the message is to be sent from
		$mail->setFrom('ghostlikitchen@gmail.com', 'Ghostli Kitchen');

		//Set an alternative reply-to address
		$mail->addReplyTo('ghostlikitchen@gmail.com', 'Ghostli Kitchen');
