...
(function(factory) {
    ...
    var PagesCalendar = function(element, options) {
        ...
        */ 
         ...
         * @access protected
         */
        wView.prototype.renderEvent = function(eventStartHours, eventStartMins, eventEndHours, evenEndMins, cellNo, arrayIndex, eventDuration, bgColor) {
            ...
            while(remainingMins > 0){
                if( remainingMins > this.maxMinsPerDay){
                    ...
                    $(slotParent.children()[slotNumber]).append(this._buildEventElement(height,arrayIndex,cellNo,eventStartHours, eventStartMins, eventEndHours, evenEndMins, bgColor));
                    eventStartHours = 0;
                    eventStartMins = 0;
        ...
        wView.prototype._buildEventElement = function(h,arrayIndex,cellNo,eventStartHours, eventStartMins, eventEndHours, evenEndMins, bgColor){
            ...
            var eventContent = "<div data-bg-color='" + bgColor + "' class='event-container " + Calendar.settings.events[arrayIndex].class+ " "+readonly+"' data-event-duration=" + moment(Calendar.settings.events[arrayIndex].end).diff(Calendar.settings.events[arrayIndex].start, 'minutes')  + " data-index=" + arrayIndex + " data-startTime=" + Calendar.settings.events[arrayIndex].start + " data-endTime=" + Calendar.settings.events[arrayIndex].end + " id=" + id + " data-id=" + id + " data-row=" + (parseInt(eventStartHours)) + " data-cell=" + cellNo + " style=" + h + ">";
        ...
        */
        wView.prototype._drawEvent = function() {
           ...
           for(var i = 0; i < _eventIndex.length; i++){
                ...
                var bgColor = Calendar.settings.events[index].bgColor;
                ...
                if(Calendar.settings.ui.grid.eventBubble){
                    if (Calendar.settings.events[index].class != null && Calendar.settings.events[index].class != "") {
                        this._setEventBubble(Calendar.settings.events[index].class,cellNo);
                    }
                }

                this.renderEvent(eventStartHours, eventStartMins, eventEndHours, evenEndMins, cellNo, index, eventDuration, bgColor);  
        ...
        wView.prototype.collisionGroups = function(_eventIndex){
            console.log(Calendar.settings.events[_eventIndex[2]]);
            var collisionGroups = [];
            var tempGroups = [];
        ...
        Calendar = {
            ...
            constructEventForUser: function(i) {
                ...
                var eventO = {
                    ...
                    bgColor: Calendar.settings.events[i].bgColor,
