(function($) {
    ...
    * Pages.
    ...
    var Pages = function() {
        this.VERSION = "4.1.0";
        this.AUTHOR = "Scouty";
        this.SUPPORT = "eddythemeddy@gmail.com";
    ...
    */
    ...
    // Pages.prototype.format = function() {
    //     var args = arguments;
    ...
    */
    Pages.prototype.isVisibleMd = function() {
        if(this.screenWidth > 1024 && this.screenWidth <= 1200) {
            return true;
        }
    }
    ...
    */
    ...
    // Pages.prototype.commas = function(num){
     ...
     Sidebar.prototype.togglePinSidebar = function(toggle) {
        ...
        var pin = null;
         ...
         if (toggle == 'hide') {
            ...
            pin = this.$body.hasClass('menu-pin');
         }
